        ...
        <main>
          ...
          {/* CARDS */}
            <div className={'py-3 px-36 mt-10 flex flex-wrap'}>
              {/* CARD */}
              <div className={'w-64 h-72 m-3 rounder overflow-hidden border cursor-pointer'}>
                <img src={'https://resizer.otstatic.com/v2/photos/wide-huge/3/29130384.jpg'} alt={''} className={'w-full h-36'} />
                <div className={'p-1'}>
